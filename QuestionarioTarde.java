...
public class QuestionarioTarde extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questionario_tarde);
    ...
    private void submeterRespostas() {
        ...
        if (idRadioButton1 != -1 && idRadioButton2 != -1 && idRadioButton3 != -1 && idRadioButton4 != -1 && idRadioButton5 != -1 && idRadioButton6 != -1 && idRadioButton7 != -1 && idRadioButton8 != -1 && idRadioButton9 != -1 ) {
            ...
            Resposta Resposta1 = new Resposta("Onde esteve no decorrer da manhã?", radioButton1.getText().toString(), valorSentimento1, timestamp);
            Resposta Resposta2 = new Resposta("Com quem esteve de manhã?", radioButton2.getText().toString(), valorSentimento2, timestamp);
            Resposta Resposta3 = new Resposta("O que esteve a fazer de manhã?", radioButton3.getText().toString(), valorSentimento3, timestamp);
            ...
            Toast.makeText(QuestionarioTarde.this, "Responda a Todas as Perguntas", Toast.LENGTH_SHORT).show();
