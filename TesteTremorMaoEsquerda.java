...
public class TesteTremorMaoEsquerda extends AppCompatActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void iniciarTeste() {
            ...
            sensorManager.registerListener((SensorEventListener) TesteTremorMaoEsquerda.this, accelerometer, SensorManager.SENSOR_DELAY_FASTEST);

            sensorManager.registerListener((SensorEventListener) TesteTremorMaoEsquerda.this, gyroscope, SensorManager.SENSOR_DELAY_FASTEST);
            ...
            new CountDownTimer(10000, 1000) {
                ...
                public void onFinish() {
                    ...
                    sensorManager.unregisterListener((SensorEventListener) TesteTremorMaoEsquerda.this, accelerometer);
                    sensorManager.unregisterListener((SensorEventListener) TesteTremorMaoEsquerda.this, gyroscope);
        ...
        private void enviarDadosParaFirebase(String tipo, float x, float y, float z) {
            ...
            if (uid != null) {
                ...
                TesteRef.child("testes").child("teste mao esquerda").push().setValue(dados);
            } else {
